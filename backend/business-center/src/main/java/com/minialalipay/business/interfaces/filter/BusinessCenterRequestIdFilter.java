package com.minialalipay.business.interfaces.filter;
...
/**
 * 在业务中心请求入口建立请求编号上下文，并保证响应始终返回相同编号。
 */
@Component
@Order(Ordered.HIGHEST_PRECEDENCE)
public class BusinessCenterRequestIdFilter extends OncePerRequestFilter {
    ...
    public BusinessCenterRequestIdFilter(RequestIdGenerator requestIdGenerator) {
