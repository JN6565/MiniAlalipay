...
class ApiResponseTest {
    ...
    void successUsesStableEnvelopeAndPreservesRequestId() {
        ApiResponse<String> response = ApiResponse.success("accepted", "req-001");
        ...
        assertThat(response.data()).isEqualTo("accepted");
    }

    @Test
    void failureDoesNotExposeData() {
        ApiResponse<Void> response = ApiResponse.failure(CommonErrorCode.INVALID_REQUEST, "req-002");
