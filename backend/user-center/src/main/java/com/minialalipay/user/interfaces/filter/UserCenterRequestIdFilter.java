package com.minialalipay.user.interfaces.filter;
...
/**
 * 在用户中心请求入口建立请求编号上下文，并保证响应始终返回相同编号。
 */
@Component
@Order(Ordered.HIGHEST_PRECEDENCE)
public class UserCenterRequestIdFilter extends OncePerRequestFilter {
    ...
    public UserCenterRequestIdFilter(RequestIdGenerator requestIdGenerator) {
